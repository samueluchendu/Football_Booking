...
<body>
    ...
    <?php
        ...
        */
          $errors = array('cfirstname' => '', 'clastname'=> '', 'cemail'=>'','cphone'=>'','caddress'=>'');
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            if(isset($_POST["submit"] ))
            {
                ...
                if(empty($_POST["cfirstname"] )){
                    $errors['cfirstname'] ="Please enter required field firstname";
                    // Show error alert
                    echo '<div class="my-0 alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Error!</strong> Customer was not Added ' .$errors['cfirstname']. 
                ...
                if(empty($_POST["clastname"] )){
                    $errors['clastname']= "Please enter required field lastname";
                    echo '<div class="my-0 alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Error!</strong> Customer was not Added ' .$errors['clastname']. 
                    '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }

                if(empty($_POST["cemail"] )){
                    $errors['cemail'] ="Please enter required field Email";
                    echo '<div class="my-0 alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Error!</strong> Customer was not Added ' .$errors['cemail']. 
                    '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }

                if(empty($_POST["cphone"] )){
                    $errors['cphone']= "Please enter required field Phone";
                    echo '<div class="my-0 alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Error!</strong> Customer was not Added ' .$errors['cphone']. 
                    '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }

                if(empty($_POST["caddress"] )){
                    $errors['caddress']= "Please enter required field Address";
                    echo '<div class="my-0 alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Error!</strong> Customer was not Added ' .$errors['caddress']. 
                    '<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>';
                }
                ...
                if(array_filter($errors)){
                      // Show error alert
                    //    echo '<div class="my-0 alert alert-danger alert-dismissible fade show" role="alert">
                    //    <strong>Error!</strong> Customer was not Added as some field was missing, Kindly Retry
                    //    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    //    </div>';
               ...
               // Generates the unique userid
                ...
                //     // Route is unique, proceed
                    $sql = "INSERT INTO `customers` (`customer_id`,`customer_firstname`,`customer_lastname`, `customer_phone`,`customer_email`,`customer_address`, `customer_created`) VALUES ('$customer_id','$cfirstname', '$clastname','$cphone','$cemail','$caddress', current_timestamp());";
            ...
            if(isset($_POST["edit"]))
            {
                ...
                $cphone = $_POST["cphone"];
                $id = $_POST["id"];
                $id_if_customer_exists = exist_customers($conn,$firstname,$cphone);
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <button class="button edit-button " data-link="<?php echo $_SERVER['REQUEST_URI']; ?>" 
                                                ...
                                                data-name="<?php echo $customer_firstname;?>"
                                                data-lname="<?php echo $customer_lastname;?>"
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form name="f1" id="addCustomerForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST" >
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="cemail" class="form-label">Contact Email</label>
                            ...
                            <div class="mb-3">
                                <label for="caddress" class="form-label">Contact Address</label>
                                <input type="text" class="form-control" id="caddress" name="caddress">
                            </div>
                            <div class="mb-3">
                                <label for="file" class="form-label">Upload Valid ID</label>
